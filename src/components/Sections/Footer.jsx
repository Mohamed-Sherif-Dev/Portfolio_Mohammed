...
const Footer = () => {
  ...
  const scrollY = useTransform(scrollYProgress, [0, 1], ["0px", "-50px"]);
  ...
  const socialLinks = [
    ...
    },
    {
      name: "Email",
      icon: Mail,
      url: "mailto:momh120130@gmail.com",
  ...
  return (
    ...
    >
      ...
      <div className=" relative z-10 px-6 py-16">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="">
              <motion.div
                className=" inline-block items-center space-x-2 text-2xl font-medium"
              ...
              >
                Where passion meets precision to create unforgettable digital
                experiences
              </motion.p>
            </motion.div>
        ...
        ${s.color}`}
                    whileHover={{ scale: 1.1, y: -2, rotate: [0, -5, 0] }}
                    whileTap={{ scale: 0.95 }}
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              <p className={`text-xs ${isDarkMode ? "text-gray-600" : "text-gray-500"}`}>
                Builte with React & Farmer Motion . Designed Wiht care
              </p>
            </motion.div>
