    ...
    >
        ...
        <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
                ...
                } mt-4 max-w-2xl mx-auto font-light`}
                >
                    A showcase of my technical skills and the tools I use to build
            ...
            {SKILLS_CATEGORY.map((category , index)=>(
                ...
                className={`p-8 rounded-2xl border ${
                    isDarkMode 
                    ? "bg-gray-900/50 border-blue-800 backdrop-blur-sm"
                ...
                >
                    ...
                    <div className="flex items-center gap-1 mb-6">
                        <div className={`p-3 rounded-xl ${
                            isDarkMode ? "bg-blue-800/20" : "text-gray-100"
                        }`}
                        >
                        ...
                        {category.skills.map((skill , skillIndex)=>(
                            <div key={skill.name} className="">
                                ...
                                >
                                    ...
                                    >
                                        <div className="absolute inset-0 bg-white/20 rounded-full opacity-0 group-hover:opacity-10 transition-opacity duration-300" />
                                    </motion.div>
                            </div>
                            </div>
                        ))}
            ...
            >
                {STATS.map((stat , index)=>(
                    ...
                    >
                        <div className="text-3xl md:text-4xl font-semibold mb-2 text-blue-500 ">
                            {stat.number}
                        </div>
